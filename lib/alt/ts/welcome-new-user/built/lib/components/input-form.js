...
var InputForm = (function (_super) {
    ...
    Object.defineProperty(InputForm.prototype, "error", {
        get: function () {
            ...
            return React.createElement(error_message_1.default, __assign({}, { errors: errors, name: name }));
        },
        enumerable: true,
        configurable: true
    });
    InputForm.prototype.render = function () {
        ...
        return React.createElement("div", {className: "input-form"}, this.label, React.createElement("input", __assign({className: state}, { type: type, name: name, placeholder: placeholder, value: value, onChange: function (e) { return onChange(e.target.value); } })), this.error);
    };
    return InputForm;
}(parcel_1.Good));
