...
var ErrorMessage = function (_Good) {
  _inherits(ErrorMessage, _Good);
...
},{"../fa":37,"../models/state":38,"../parcel":39}],35:[function(require,module,exports){
'use strict';
...
var InputForm = function (_Good) {
  _inherits(InputForm, _Good);
...
},{"../fa":37,"../models/state":38,"../parcel":39,"./error-message":34}],36:[function(require,module,exports){
'use strict';
...
var SubmitButton = function (_Good) {
  _inherits(SubmitButton, _Good);
...
},{"../fa":37,"../models/state":38,"../parcel":39}],37:[function(require,module,exports){
'use strict';
...
var Fa = function (_Component) {
  _inherits(Fa, _Component);
...
exports.Parcel = exports.Good = undefined;
...
var Good = exports.Good = function (_Component) {
  _inherits(Good, _Component);

  function Good() {
    _classCallCheck(this, Good);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(Good).apply(this, arguments));
  }
...
var Parcel = exports.Parcel = function (_Good) {
  _inherits(Parcel, _Good);
  ...
  function Parcel(props) {
    ...
    var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Parcel).call(this, props));
...
var Context = function (_Parcel) {
  _inherits(Context, _Parcel);
...
var Component = function (_Good) {
  _inherits(Component, _Good);
...
},{"./lib/components/input-form":35,"./lib/components/submit-button":36,"./lib/fa":37,"./lib/models/state":38,"./lib/parcel":39,"./lib/services/strike-api":40}]},{},[41]);
