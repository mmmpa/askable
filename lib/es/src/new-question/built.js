...
},{"../../addon/mode/overlay":2,"../../lib/codemirror":3,"../markdown/markdown":9}],7:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":3,"../css/css":5,"../javascript/javascript":8,"../xml/xml":11}],8:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":3}],9:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":3,"../meta":10,"../xml/xml":11}],10:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../lib/codemirror":3}],11:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":3}],12:[function(require,module,exports){
(function (global){
/**
...
var Assigner = function (_ComponentComponent) {
  _inherits(Assigner, _ComponentComponent);

  function Assigner(props) {
    _classCallCheck(this, Assigner);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Assigner).call(this, props));
  ...
  _createClass(Assigner, [{
    key: 'isAssigned',
    value: function isAssigned(userLogin) {
      return _.includes(this.state.assigned, userLogin);
    }
  }, {
    key: 'isStateChanged',
    value: function isStateChanged(state) {
    ...
    key: 'assignUser',
    value: function assignUser(userLogin) {
    ...
    key: 'writeAssigner',
    value: function writeAssigner() {
      var _this2 = this;

      var _props = this.props;
      var user = _props.user;
      var group = _props.group;
      var already = _props.already;

      var exclusion = (already || []).concat(user.login);
      var users = group.users.filter(function (user) {
        return !_.includes(exclusion, user.login);
      });
      return h(
        'section',
        { className: 'assigner group-members' },
        h(
          'section',
          { className: 'assigner group-member-list' },
          users.map(function (_ref) {
            ...
            return h(
              'label',
              { className: 'assigner group-member', key: login },
              h(
                'span',
                { className: 'input-input' },
                h('input', { type: 'checkbox', name: 'assign',
                  checked: _this2.isAssigned(login),
                  onChange: function onChange() {
                    return _this2.assignUser(login);
                  } })
              ),
              h(
                'span',
    ...
    value: function render() {
      ...
      return h(
        'article',
        { className: 'assigner body' },
        h(
          'section',
          { className: 'assigner tabs tabnav' },
          h(
            'nav',
            ...
            h(
              ...
              h(_fa2.default, { icon: 'hand-o-right' }),
              '回答をおねがいする'
            )
          )
        ),
        this.writeAssigner(),
        h(_errorMessages2.default, _extends({ name: 'assigned' }, { errors: errors }))
      );
    }
  }]);
...
},{"../fa":18,"../models/group":19,"../models/user":21,"../parcel":22,"./error-messages":16}],14:[function(require,module,exports){
'use strict';
...
var CommentEditor = function (_ComponentComponent) {
  _inherits(CommentEditor, _ComponentComponent);

  function CommentEditor(props) {
    _classCallCheck(this, CommentEditor);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CommentEditor).call(this, props));
  ...
  _createClass(CommentEditor, [{
    ...
    value: function componentDidMount() {
      ...
      this.cm.on('change', function (e) {
        return _this2.changeComment(e.doc.getValue());
      });
    ...
    key: 'changeComment',
    value: function changeComment(value) {
    ...
    key: 'detectTabClass',
    value: function detectTabClass(isPreview) {
      return isPreview === this.state.preview ? 'tabnav-tab selected' : 'tabnav-tab';
    }
  }, {
    key: 'writeTitleArea',
    value: function writeTitleArea() {
      var _this3 = this;
      ...
      return h(
        'section',
        { className: 'comment-editor title-area' },
        h('input', { type: 'text', name: 'title', placeholder: 'タイトルを入力',
          value: this.props.title || this.state.title,
          onChange: function onChange(e) {
            return _this3.changeTitle(e.target.value);
          } })
      );
    }
  }, {
    key: 'writeCommentArea',
    value: function writeCommentArea() {
      var errors = this.props.errors;

      var className = this.isPreview ? 'comment-editor entry-area hidden' : 'comment-editor entry-area';

      return h(
        'section',
        { className: className },
        this.writeTitleArea(),
        h(_errorMessage2.default, { errors: errors, name: 'title' }),
        h(
          'section',
          { className: 'comment-editor comment-area' },
          h('textarea', { name: 'comment', ref: 'editor', placeholder: '内容をここに入力',
            value: this.state.markdown })
        ),
        h(_errorMessage2.default, { errors: errors, name: 'markdown' })
      );
    }
  }, {
    key: 'writePreviewArea',
    value: function writePreviewArea() {
      if (!this.isPreview) {
        return null;
      }
      ...
      if (this.state.markdown === '') {
        return h(
          'section',
          { className: 'comment-editor preview-area' },
          h(
            'p',
            { className: 'comment-editor blank-comment' },
            'コメントが入力されていません'
          )
        );
      }
      ...
      return h(
        'section',
        { className: 'comment-editor preview-area' },
        h('section', { className: 'markdown-html', dangerouslySetInnerHTML: this.marked })
      );
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return h(
        'section',
        { className: 'comment-editor editor-area' },
        h(
          'section',
          { className: 'comment-editor tabs tabnav' },
          h(
            'nav',
            { className: 'tabnav-tabs' },
            h(
              ...
              { className: this.detectTabClass(false),
                onClick: function onClick() {
                  return _this4.setState({ preview: false });
                } },
              h(_fa2.default, { icon: 'pencil' }),
              '書く'
            ),
            h(
              'a',
              { className: this.detectTabClass(true),
                onClick: function onClick() {
                  return _this4.setState({ preview: true });
                } },
              h(_fa2.default, { icon: 'file-text-o' }),
              'プレビュー'
            )
          )
        ),
...
},{"../fa":18,"../parcel":22,"./error-message":15,"codemirror":3,"codemirror/addon/display/placeholder.js":1,"codemirror/addon/mode/overlay.js":2,"codemirror/mode/clike/clike.js":4,"codemirror/mode/css/css.js":5,"codemirror/mode/gfm/gfm.js":6,"codemirror/mode/htmlmixed/htmlmixed.js":7,"codemirror/mode/javascript/javascript.js":8,"codemirror/mode/markdown/markdown.js":9,"codemirror/mode/meta.js":10,"codemirror/mode/xml/xml.js":11,"marked":12}],15:[function(require,module,exports){
'use strict';
...
},{"../fa":18,"../models/state":20,"../parcel":22}],16:[function(require,module,exports){
'use strict';
...
var ErrorMessages = function (_ComponentComponent) {
  _inherits(ErrorMessages, _ComponentComponent);
...
},{"../fa":18,"../parcel":22}],17:[function(require,module,exports){
'use strict';
...
},{"../fa":18,"../models/state":20,"../parcel":22}],18:[function(require,module,exports){
"use strict";
...
var Group = function Group(params) {
  _classCallCheck(this, Group);

  this.name = params.name || '';
  this.users = params.users.map(function (user) {
...
},{"./user":21}],20:[function(require,module,exports){
"use strict";
...
var _commentEditor = require('./lib/components/comment-editor');

var _commentEditor2 = _interopRequireDefault(_commentEditor);

var _assigner = require('./lib/components/assigner');

var _assigner2 = _interopRequireDefault(_assigner);

var _user = require('./lib/models/user');

var _user2 = _interopRequireDefault(_user);

var _group = require('./lib/models/group');
...
var Context = function (_ContextComponent) {
  ...
  _createClass(Context, [{
    key: 'succeed',
    value: function succeed(questionId) {
    ...
    value: function submit(params) {
      ...
      _strikeApi2.default.createQuestion(params).then(function (_ref) {
        var id = _ref.id;
  ...
  _createClass(Component, [{
    ...
    value: function render() {
      ...
      return h(
        ...
        h(
          'section',
          { className: 'new-question box-body' },
          h(
            'div',
            { className: 'columns' },
            h(
              'section',
              { className: 'new-question editor-area' },
              h(_commentEditor2.default, _extends({ errors: errors }, { onChange: function onChange(state) {
              ...
              h(
                ...
                h(
                  'section',
                  { className: 'new-question submit-section' },
            ...
            h(
              'section',
              { className: 'new-question assigning-area' },
              h(_assigner2.default, _extends({ errors: errors, user: user, group: group }, { onChange: function onChange(state) {
                  return _this5.setState(state);
                } }))
            )
          )
    ...
    get: function get() {
      ...
      var markdown = _state.markdown;
      var assigned = _state.assigned;
...
var NewQuestion = function () {
  ...
  _createClass(NewQuestion, null, [{
    key: 'start',
    value: function start(dom) {
      var questionPage = dom.getAttribute('data-questionPage');
      var groupId = dom.getAttribute('data-groupId');
      var user = new _user2.default(JSON.parse(dom.getAttribute('data-user')));
      var group = new _group2.default(JSON.parse(dom.getAttribute('data-group')));

      ReactDOM.render(h(
        Context,
        { questionPage: questionPage, user: user, group: group, groupId: groupId },
        h(Component, null)
      ), dom);
    }
  }]);
...
},{"./lib/components/assigner":13,"./lib/components/comment-editor":14,"./lib/components/submit-button":17,"./lib/fa":18,"./lib/models/group":19,"./lib/models/state":20,"./lib/models/user":21,"./lib/parcel":22,"./lib/services/strike-api":23}]},{},[24]);
