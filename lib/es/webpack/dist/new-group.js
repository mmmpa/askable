...
/***/ function(module, exports, __webpack_require__) {
	...
	var _errorMessage = __webpack_require__(22);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inputForm = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inputWriter = __webpack_require__(25);
	...
	var Context = function (_ContextComponent) {
	  ...
	  _createClass(Context, [{
	    key: 'succeed',
	    value: function succeed(groupId) {
	    ...
	    value: function submit(params) {
	      ...
	      _strikeApi2.default.createGroup(params).then(function (result) {
	        _this2.succeed(result.id);
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            (0, _inputWriter.writeInput)(this, 'text', 'name', 'グループの名前', null, errors),
	            (0, _inputWriter.writeInput)(this, 'text', 'description', 'グループの概要', null, errors),
	            React.createElement(
	              'section',
