...
/***/ function(module, exports, __webpack_require__) {
	...
	var _questionFinisher = __webpack_require__(52);

	var _questionFinisher2 = _interopRequireDefault(_questionFinisher);

	var _questionResponder = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../question-responder\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var _questionResponder2 = _interopRequireDefault(_questionResponder);

	var _replyToReply = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../reply-to-reply\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var _replyToReply2 = _interopRequireDefault(_replyToReply);

	var _anchorColoring = __webpack_require__(1);

	var _anchorColoring2 = _interopRequireDefault(_anchorColoring);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	window.QuestionFinisher = _questionFinisher2.default;
	window.QuestionResponder = _questionResponder2.default;
	window.ReplyToReply = _replyToReply2.default;
	window.AnchorColoring = _anchorColoring2.default;
