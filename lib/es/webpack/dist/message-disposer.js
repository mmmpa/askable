...
/***/ function(module, exports, __webpack_require__) {
	...
	var Context = function (_ContextComponent) {
	  ...
	  _createClass(Context, [{
	    ...
	    value: function submit() {
	      ...
	      strike(Api.DisposeMessage, this.setBase({})).then(function () {
	        _this2.succeed();
	...
	var Component = function (_ComponentComponent) {
	  ...
	  _createClass(Component, [{
	    ...
	    value: function render() {
	      ...
	      return React.createElement(_submitButton2.default, {
	        state: state, icon: "ban", text: "メッセージを削除する", className: 'dispose',
	        onClick: function onClick() {
	          return _this5.dispatch('dispose');
	        }
	      });
	    }
	  }]);
	...
	var MessageDisposer = function () {
	  function MessageDisposer() {
	    _classCallCheck(this, MessageDisposer);
	  }

	  _createClass(MessageDisposer, null, [{
	    key: 'start',
