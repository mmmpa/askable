...
(function(mod) {
  if (true) // CommonJS
    mod(__webpack_require__(3), __webpack_require__(8), __webpack_require__(15));
  else if (typeof define == "function" && define.amd) // AMD
...
var UnrenderingTextarea = function (_ComponentComponent) {
  _inherits(UnrenderingTextarea, _ComponentComponent);

  function UnrenderingTextarea() {
    _classCallCheck(this, UnrenderingTextarea);

    return _possibleConstructorReturn(this, (UnrenderingTextarea.__proto__ || Object.getPrototypeOf(UnrenderingTextarea)).apply(this, arguments));
  }

  _createClass(UnrenderingTextarea, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement('textarea', { name: 'comment', ref: function ref(e) {
            _this3.editor = e;
  ...
  return UnrenderingTextarea;
}(_parcel.ComponentComponent);

var CommentEditor = function (_ComponentComponent2) {
  _inherits(CommentEditor, _ComponentComponent2);

  function CommentEditor(props) {
    _classCallCheck(this, CommentEditor);

    var _this4 = _possibleConstructorReturn(this, (CommentEditor.__proto__ || Object.getPrototypeOf(CommentEditor)).call(this, props));
  ...
  _createClass(CommentEditor, [{
      ...
      return React.createElement(
        ...
        React.createElement('input', { type: 'text', name: 'title', placeholder: 'Title',
          ...
          onChange: function onChange(e) {
            return _this5.changeTitle(e.target.value);
          } })
      );
    }
  }, {
    ...
    value: function writeCommentArea() {
      ...
      return React.createElement(
        ...
        { className: className },
        this.writeTitleArea(),
        React.createElement(_errorMessage2.default, { errors: errors, name: 'title' }),
        React.createElement(UnrenderingTextarea, { changeComment: function changeComment() {
            return _this6.changeComment.apply(_this6, arguments);
          }, markdown: this.state.markdown }),
        React.createElement(_errorMessage2.default, { errors: errors, name: 'markdown' })
      );
    }
  }, {
    ...
    value: function writePreviewArea() {
      ...
      return React.createElement(
        'section',
        { className: 'comment-editor preview-area' },
        React.createElement('section', { className: 'markdown-html', dangerouslySetInnerHTML: this.marked })
      );
    }
  }, {
    key: 'render',
            ...
            React.createElement(
              ...
              { className: this.detectTabClass(false),
                onClick: function onClick() {
                  return _this7.setState({ preview: false });
                } },
              React.createElement(_fa2.default, { icon: 'pencil' }),
              'Edit'
            ),
            React.createElement(
              'a',
              { className: this.detectTabClass(true),
                onClick: function onClick() {
                  return _this7.setState({ preview: true });
                } },
              React.createElement(_fa2.default, { icon: 'file-text-o' }),
              'Preview'
            )
          )
        ),
    ...
    get: function get() {
      ...
      var __html = (0, _marked2.default)(markdown, { sanitize: true });
...
(function(mod) {
  if (true) // CommonJS
    mod(__webpack_require__(3), __webpack_require__(14), __webpack_require__(11));
  else if (typeof define == "function" && define.amd) // AMD
...
(function(mod) {
  if (true) // CommonJS
    mod(__webpack_require__(3), __webpack_require__(8), __webpack_require__(13), __webpack_require__(12));
  else if (typeof define == "function" && define.amd) // AMD
...
var _commentEditor = __webpack_require__(16);
...
var Context = function (_ContextComponent) {
  ...
  _createClass(Context, [{
    ...
    value: function submit(params) {
      ...
      _strikeApi2.default.replyToReply(this.setBase(params)).then(function () {
        _this2.succeed();
      }).catch(function (_ref) {
  ...
  _createClass(Component, [{
    ...
    value: function writeResponder() {
      ...
      return React.createElement(
        'section',
        null,
        React.createElement(_commentEditor2.default, _extends({
          errors: errors,
          markdown: markdown
        }, { title: 'not required', onChange: function onChange(state) {
    ...
    value: function render() {
      return React.createElement(
        'article',
        { className: 'reply-to-reply body' },
        React.createElement(
          'section',
          { className: 'reply-to-reply responder-area' },
          this.writeResponder()
        )
      );
    }
...
var ReplyToReply = function () {
  function ReplyToReply() {
    _classCallCheck(this, ReplyToReply);
  }

  _createClass(ReplyToReply, null, [{
    key: 'opener',
    value: function opener(doms) {
      _.each(doms, function (dom) {
        ...
        dom.addEventListener('click', function (e) {
          ...
          ReactDOM.render(React.createElement(
            Context,
            { commentId: commentId, questionId: questionId, groupId: groupId },
