      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            (0, _inputWriter.writeInput)(this, 'text', 'name', 'Name', null, errors),
            (0, _inputWriter.writeInput)(this, 'text', 'description', 'Description', null, errors),
            React.createElement(
              'section',
              { className: 'com submit-section' },
              React.createElement(_submitButton2.default, {
                state: state, icon: "thumbs-o-up", text: "Create", className: 'submit',
