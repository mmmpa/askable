...
var Context = function (_ContextComponent) {
  ...
  _createClass(Context, [{
    ...
    value: function listen(to) {
      ...
      to('accept', function () {
        return _this3.submit(_strikeApi2.default.acceptInvitation);
      });
      to('reject', function () {
        return _this3.submit(_strikeApi2.default.rejectInvitation);
      });
      to('block', function () {
        return _this3.submit(_strikeApi2.default.blockInvitation);
      });
    }
  }, {
    key: 'initialState',
    ...
    value: function writeForm() {
      ...
      return React.createElement(
        ...
        React.createElement(_submitButton2.default, {
          state: state, icon: "thumbs-o-up", text: "Accept", className: 'submit',
          onClick: function onClick() {
            return _this5.dispatch('accept');
          }
        }),
        React.createElement(_submitButton2.default, {
          state: state, icon: "trash", text: "Reject", className: 'reject',
          onClick: function onClick() {
            return _this5.dispatch('reject');
          }
        }),
        React.createElement(_submitButton2.default, {
          state: state, icon: "ban", text: "Block", className: 'reject',
          onClick: function onClick() {
